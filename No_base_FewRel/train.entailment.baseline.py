...
class InputExample(object):
    ...
    def __init__(self, guid, text_a, span_a_left=None, span_a_right=None, text_b=None, span_b_left=None, span_b_right=None, label=None, premise_class=None):
                ...
                for class_name, example_list in dev_data.items():
                    for example in example_list:
                        ...
                        for seen_class in seen_classes:
                            ...
                            examples.append(
                                InputExample(guid=flag, text_a=sent, span_a_left=head_left, span_a_right=head_right, text_b=seen_class, span_b_left=tail_left, span_b_right=tail_right, label='entailment', premise_class=class_name))
