...
def main():
    ...
    print('num_labels:', num_labels, 'round 1 training size:', len(round_1_train_examples))#, 'base dev size:', len(base_dev_examples), 'base test size:', len(base_test_examples))
    ...
    if args.do_train:
        ...
        base_train_dataloader = examples_to_features(round_1_train_examples, label_list, class_list, args, tokenizer, args.train_batch_size, "classification", dataloader_mode='random')
        ...
        logger.info("  Num examples = %d", len(round_1_train_examples))
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            store_transformers_models(model_to_save, tokenizer, '/export/home/Dataset/BERT_pretrained_mine/MNLI_pretrained', 'incremental.round.1.pt')
