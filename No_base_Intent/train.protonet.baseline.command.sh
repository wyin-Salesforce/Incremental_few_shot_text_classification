...
CUDA_VISIBLE_DEVICES=1 python -u train.protonet.baseline.py \
    ...
    --max_seq_length 64 \
    --seed $SEED \
    --round_name r1 > log.nobase.prototype.r1.seed.$SEED.txt 2>&1 &
...
CUDA_VISIBLE_DEVICES=2 python -u train.protonet.baseline.py \
    ...
    --max_seq_length 64 \
    --seed $SEED \
    --round_name r2 > log.nobase.prototype.r2.seed.$SEED.txt 2>&1 &
...
CUDA_VISIBLE_DEVICES=3 python -u train.protonet.baseline.py \
    ...
    --max_seq_length 64 \
    --seed $SEED \
    --round_name r3 > log.nobase.prototype.r3.seed.$SEED.txt 2>&1 &
...
CUDA_VISIBLE_DEVICES=0 python -u train.protonet.baseline.py \
    ...
    --max_seq_length 64 \
    --seed $SEED \
    --round_name r4 > log.nobase.prototype.r4.seed.$SEED.txt 2>&1 &
...
CUDA_VISIBLE_DEVICES=5 python -u train.protonet.baseline.py \
    ...
    --max_seq_length 64 \
    --seed $SEED \
    --round_name r5 > log.nobase.prototype.r5.seed.$SEED.txt 2>&1 &
