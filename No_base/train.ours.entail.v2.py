    ...
    def load_train(self, round_list):
        ...
        for round in round_list:
            ...
            for row in readfile:
                ...
                '''positive pair'''
                examples_this_round.append( InputExample(guid=0, text_a=example_str, text_b=class_str, label='entailment', premise_class=class_name, hypothesis_class = class_name))
                ...
                for negative_class in negative_class_set:
                    ...
                    examples_this_round.append( InputExample(guid=0, text_a=example_str, text_b=class_str, label='non-entailment', premise_class=class_name, hypothesis_class = negative_class))
        ...
        for round in round_list:
            ...
            for row in readfile:
                ...
                for seen_class in seen_classes:
                    ...
                    for _ in range(3):
                        examples.append(
                            InputExample(guid=instance_id, text_a=example_str, text_b=class_str, label='entailment', premise_class=class_name, hypothesis_class = seen_class))
